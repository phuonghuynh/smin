...
smin.controller("companyRegistrationController", function($scope, connectionFactory, $location) {
  //console.log("konsole");
...
smin.controller("companyListController", function($scope, $http, $location) {
  $http.get('company')
